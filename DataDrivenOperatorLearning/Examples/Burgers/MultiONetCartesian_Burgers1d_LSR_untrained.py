...
if __name__ == '__main__':
    ...
    netType = 'MultiONetCartesian_Tanh_untrained'

    hidden_list, act_x, act_a = [128]*3, 'Tanh', 'Tanh'
    model = solver.getModel(x_in_size=1, a_in_size=128, hidden_list=hidden_list, 
